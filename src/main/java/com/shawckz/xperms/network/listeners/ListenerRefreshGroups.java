 ...
 */
public class ListenerRefreshGroups extends NetworkListener {

    public ListenerRefreshGroups() {
        super(NetworkEvent.REFRESH_GROUPS);
    }
            ...
            if (channel.equalsIgnoreCase(getNetworkEvent().getEvent())) {
                new BukkitRunnable() {
                    ...
                    public void run() {
                        ...
                        XNetworkManager.staffMessage("Loaded groups from database.");
