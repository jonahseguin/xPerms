...
public class CmdRemoveSubgroup implements GCommand {

    @GCmd(name = "xperms removesubgroup", aliases = {"perms removesubgroup"}, permission = "xperms.removesubgroup",
            usage = "/xperms removesubgroup <group> <server> <subgroup>", minArgs = 3)
            ...
            public void run() {
                ...
                if (group != null) {
                    ...
                    if (permServer != null) {
                        ...
                        if (subGroup != null) {
                            if (group.getSubGroups().hasSubGroup(subGroup)) {
                                group.getSubGroups().removeSubGroup(subGroup);
                                ...
                                sender.sendMessage("&cThat group does not have that subgroup.");
                            }
                        } else {
